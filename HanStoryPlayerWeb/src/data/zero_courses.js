...
これは いくらですか。|これは いくらですか|ko-re wa i-ku-ra des-ka|これはいくらですか。|¿Cuánto cuesta esto?`)
  ],quiz:quiz('Japanese',[['meaning','すみません','Disculpe.','Gracias.','Agua.'],['sound','っ pequeña','きって','きて','きいって'],['symbol','Escucha “みず”','みず','みせ','みち'],['meaning','トイレはどこですか','¿Dónde está el baño?','¿Cuánto cuesta?','No entiendo.']])},

...
const LANGUAGE_PAGES={
  ...
  Korean:[
    page('korean-consonants','Consonantes',rows(['ㄱ','ㄴ','ㄷ','ㄹ','ㅁ','ㅂ','ㅅ','ㅇ','ㅈ','ㅊ'],['ㅋ','ㅌ','ㅍ','ㅎ'],['ㄲ','ㄸ','ㅃ','ㅆ','ㅉ'],['ㄳ','ㄵ','ㄶ','ㄺ','ㄻ','ㄼ','ㄽ','ㄾ','ㄿ','ㅀ','ㅄ'])),
    page('korean-vowels','Vocales',rows(['ㅏ','ㅑ','ㅓ','ㅕ','ㅗ','ㅛ','ㅜ','ㅠ','ㅡ','ㅣ'],['ㅐ','ㅒ','ㅔ','ㅖ'],['ㅘ','ㅙ','ㅚ','ㅝ','ㅞ','ㅟ','ㅢ']))
  ],
  Japanese:[

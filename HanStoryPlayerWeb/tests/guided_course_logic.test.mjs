...
import{completeGuidedLesson,completeGuidedReview,defaultGuidedProgress,GUIDED_REVIEW_INTERVAL_DAYS,reviewSchedule,scoreActivities}from'../src/guided_course_logic.js';
